...
proxies = {
           'http': 'http://lelmcbsw-rotate:2060ugdxlk5z@p.webshare.io:80/',
           'https': 'http://lelmcbsw-rotate:2060ugdxlk5z@p.webshare.io:80/'
}
...
async def helpstr(message: types.Message):
    ...
    btns = types.InlineKeyboardButton("𝐀𝐃𝐃 𝐌𝐄 𝐁𝐀𝐁𝐘", url=f"https://t.me/{app.username}?startgroup=true"),
    keyboard_markup.row(btns)
    FIRST = message.from_user.first_name
    MSG = f'''
Hello {FIRST}, 
Im {BOT_NAME} First edition 🤍
U can find my Boss  <a href="tg://user?id={OWNER}">𝐃𝙰𝚇𝚇</a>
Cmds 
/chk 
/info 
/bin'''
